...
plt.legend()
plt.title('PR Curve')
plt.savefig('steel_t4_PR_BigUnet.png')
plt.clf()
...
ax.legend()
ax.grid()
fig.savefig('steel_t4_acc_BigUnet.png')
plt.clf()
...
ax.legend()
ax.grid()
fig.savefig('steel_t4_loss_BigUnet.png')
plt.clf()

filename = 'steel_t4_report_BigUnet.csv'
